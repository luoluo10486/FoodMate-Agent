...
实现基线：2026-07-10；M1-5 决策更新：当前没有历史数据，`food_logs` 将直接调整为主表 + 明细表，SQL 尚未执行。当前数据库人工建表脚本为 [`V1__init_core_schema.sql`](../../script/sql/FoodMate/baseline/V1__init_core_schema.sql)，后续以版本化人工 SQL 落地。

...
## M2 功能版当前状态（2026-08-22）

| 范围 | 状态 | 当前边界 |
|---|---|---|
| M2-1 公共知识库与 RAG | deterministic 本地业务闭环已完成，生产强化后置 | 已用 Docker PostgreSQL/Redis/RocketMQ/MinIO 依赖和宿主机 Java/Python 验证批量上传、索引 Outbox、RocketMQ Worker、MinIO 解析、Java 结果回写、发布/下线/恢复、用户检索和 AgentRun `run.completed` 引用；Docker 应用镜像、真实 embedding/云模型、性能与故障矩阵后置 |

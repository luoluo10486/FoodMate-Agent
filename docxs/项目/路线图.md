...
> **当前进度：当前进入 B4-2。目标架构已调整为 Java 控制面 + Python Agent Runtime，Python 工程尚未创建。已完成的前端 Phase 1-2、Java B3-1~B3-5 与 B4-1 记录见[已完成任务归档](../归档/已完成任务.md)。**

| 顺序 | 编号 | 任务 | 状态 | 预估 |
|------|------|------|------|------|
| 1 | B4-2 | 用户、认证、个人资料、会话和消息域 PO / Mapper | 当前任务 | 1d |
| 2 | B5-0 | 认证、RBAC、个人资料和头像接口 | 待开始 | 1d |
| 3 | B5-1 | 实现会话 API（CRUD） | 待开始 | 0.5d |
| 4 | B5-2~B5-4 | 消息、AgentRun、取消和真实 SSE | 待开始 | 1.5d |
| 5 | B3-6 | Python Runtime、Java Client 与内部契约迁移准备 | 待开始 | 1.5d |
| 6 | B7-1~B7-2 | Java ToolRegistry、Policy、内部工具 API 与 P0 契约 | 待开始 | 1.5d |
| 7 | B6-1~B6-4 | Python Runtime、Router、Planner、ExecutionEngine | 待开始 | 2.5d |
| 8 | B11-1 | 双运行时联调，端到端跑通第一条链路 | 待开始 | 1d |

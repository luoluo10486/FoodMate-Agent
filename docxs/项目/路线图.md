...
| 范围 | 状态 | 当前边界 |
|---|---|---|
| M2-1 公共知识库与 RAG | 核心代码已实现，业务闭环未完成 | 上传、索引、发布、检索、引用的真实跨运行时验证仍待完成 |
| M2-2 Tool Gateway 与 SQL Agent | 核心代码与定向测试已完成，联调未完成 | Tool Registry、只读 SQL Guard、双模式 Planner 和分析 AgentRun 已实现；真实数据库/运行时联调仍待完成 |

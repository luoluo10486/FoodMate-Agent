...
public class UserController extends AuthenticatedControllerSupport {
    ...
    public UserController(
            ...
            org.springframework.beans.factory.ObjectProvider<
                            com.foodmate.application.account.PersonalDataService>
                    personal) {
        super(accounts);
    ...
    public ApiResponse<com.foodmate.application.account.PersonalDataService.Avatar> uploadAvatar(
            jakarta.servlet.http.HttpServletRequest request,
    ...
    public ApiResponse<com.foodmate.application.account.PersonalDataService.ExportJob> exportStatus(
            jakarta.servlet.http.HttpServletRequest request, @PathVariable long id) {
        if (personal == null) throw new IllegalStateException("personal data unavailable");
        return ApiResponse.success(

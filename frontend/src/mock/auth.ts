...
export const mockAuthScenarios: Array<{ status: AuthStatus; title: string; description: string; code: string }> = [
  ...
  { status: 'expired', title: '登录过期', description: 'Access Token 过期后尝试刷新，失败则回到登录页。', code: 'AUTH_TOKEN_EXPIRED' },
  { status: 'disabled', title: '账号禁用', description: '账号状态不是 active 时拒绝登录。', code: 'AUTH_ACCOUNT_DISABLED' },
  { status: 'forbidden', title: '权限不足', description: '已登录但访问管理员资源时展示无权限。', code: 'AUTH_FORBIDDEN' }
];

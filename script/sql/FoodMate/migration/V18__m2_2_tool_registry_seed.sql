...
VALUES
    ...
    (721005,720005,'v1','{"type":"object","properties":{"meal_time":{"type":"string"},"meal_type":{"type":"string"},"notes":{"type":"string","maxLength":2000},"items":{"type":"array","maxItems":50},"revision":{"type":"integer","minimum":1}},"additionalProperties":false}','{"type":"object","properties":{"status":{"type":"string"},"resourceId":{"type":"string"}},"required":["status"]}','{"roles":["user","operator","admin","superadmin"],"approval":"required","scope":"user"}',10000,FALSE,TRUE,'2026-01-01T00:00:00Z',0,0),

...
- `GET /api/v1/admin/sql-audits`
- `GET /api/v1/admin/model-usage`
- `GET /api/v1/admin/deleted/resources`
...
- calculator、time_parser、knowledge_search、food_log_writer 至少有可用实现或可替换 stub。
- 饮食记录写入前必须确认。

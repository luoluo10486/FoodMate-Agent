...
public enum ErrorCode {
    ...
    TOOL_SKIP_NOT_ALLOWED("TOOL_SKIP_NOT_ALLOWED", "当前工具步骤不允许跳过", 409),
    TOOL_STEP_NOT_FOUND("TOOL_STEP_NOT_FOUND", "工具步骤不存在", 404),
    TOOL_STEP_ALREADY_RUNNING("TOOL_STEP_ALREADY_RUNNING", "工具步骤已经开始执行", 409),
    TOOL_STEP_ALREADY_RESOLVED("TOOL_STEP_ALREADY_RESOLVED", "工具步骤已经完成处理", 409),
    TOOL_STEP_STALE("TOOL_STEP_STALE", "工具步骤已经不属于当前运行尝试", 409),
    ...
    USER_AVATAR_INVALID("USER_AVATAR_INVALID", "头像文件不合法", 400),
    USER_AVATAR_UPLOAD_FAILED("USER_AVATAR_UPLOAD_FAILED", "头像上传失败", 500),
    USER_AVATAR_DOWNLOAD_FAILED("USER_AVATAR_DOWNLOAD_FAILED", "头像访问失败", 500),
    USER_AVATAR_DELETE_FAILED("USER_AVATAR_DELETE_FAILED", "头像删除失败", 500),
    USER_AVATAR_NOT_FOUND("USER_AVATAR_NOT_FOUND", "头像不存在", 404),

...
@Service
public class BudgetExtensionServiceImpl implements BudgetExtensionService {
    private final BudgetExtensionRepository store;
    ...
    public BudgetExtensionServiceImpl(

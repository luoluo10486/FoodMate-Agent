...
public interface BudgetExtensionStore {
    ...
    void insertExtension(long id, long runId, int no, int tokens, BigDecimal cost, String digest, Instant expiresAt);
    void insertSnapshot(long id, long runId, int revision, int tokens, BigDecimal cost, Snapshot source, String digest);
    ...
    void insertDispatch(long rowId, long runId, String dispatchId, int attempt, long epoch, String fence, Instant deadline);
    void insertOutbox(long outboxId, long rowId, long runId, String dispatchId, int attempt, Instant deadline, long epoch, String payload, String hash);
    ...
    record Snapshot(int revision, int tokens, BigDecimal cost, int stepRetries, int replans,
                    int answerRewrites, int totalSteps, int modelCalls, int queueTimeout,
                    int executionTimeout, int nodeTimeout, int waitingUserTimeout, String configVersion) {}
